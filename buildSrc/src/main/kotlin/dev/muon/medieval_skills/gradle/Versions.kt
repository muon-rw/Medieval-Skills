package dev.muon.medieval_skills.gradle
...
object Versions {
    ...
    const val FABRIC_API = "0.114.0+1.21.1"
    ...
    const val ACCESSORIES = "1.1.0-beta.19+1.21.1"
    ...
    const val IRONS_SPELLBOOKS = "1.21-3.8.8"

    const val ARS_NOUVEAU = "1.21.1:5.3.6.867"

    const val APOTHEOSIS = "8.0.2"
    const val APOTHIC_ATTRIBUTES = "2.5.0"
    const val APOTHIC_SPAWNERS = "1.1.1"
    ...
    const val PUFFISH_SKILLS = "0.14.2+1.21"
    const val PUFFISH_ATTRIBUTES = "0.7.1+1.21"
}